...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        sync: function sync(event) {
            ...
            this.syncing = true;
            return Nova.request().get('/nova-vendor/nova-theme/sync').then(function (response) {
                _this2.$toasted.show(_this2.__('Themes Synced Successfully'), { type: 'success' });
                _this2.getResources();
            }).finally(function () {
        ...
        getActions: function getActions() {
            ...
            return Nova.request().get('/nova-api/' + this.resourceName + '/actions', {
                ...
                _this4.actions = _.filter(response.data.actions, function (action) {
        ...
        performSearch: function performSearch(event) {
            ...
            this.debouncer(function () {
                ...
                if (event.which != 9) {
                    var _this5$updateQueryStr;

                    _this5.updateQueryString((_this5$updateQueryStr = {}, _defineProperty(_this5$updateQueryStr, _this5.pageParameter, 1), _defineProperty(_this5$updateQueryStr, _this5.searchParameter, _this5.search), _this5$updateQueryStr));
                }
            });
        },
        ...
        getAllMatchingResourceCount: function getAllMatchingResourceCount() {
            ...
            Nova.request().get('/nova-api/' + this.resourceName + '/count', {
                ...
                _this6.allMatchingResourceCount = response.data.count;
            });
        },
        ...
        _c(
          ...
          [
            ...
            _c(
              ...
              [
                _c("span", { class: { invisible: _vm.syncing } }, [
                  _vm._v(" " + _vm._s(_vm.__("Sync")) + " ")
                ]),
                _vm._v(" "),
                _vm.syncing
                  ? _c(
